...
WS.sendRequestAndVerify(findTestObject('OneWayTrip/2_Price Request'))

WS.sendRequestAndVerify(findTestObject('ReturnTrip_Payload/3_TS Intiate_Workbench_Return'))
